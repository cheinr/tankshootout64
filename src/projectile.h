...
projectile_t *projectile_init(uint32_t entityId, uint32_t parentEntityId, sprite_t* sprite, float xPosition, float yPosition, float rotationDegrees, float speed);
